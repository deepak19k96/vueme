...
class EmailUtils
{
    ...
    public static function send_email_to_user_top_rate_psychics($user, $subject, $psychics)
    {
        //# Goes to client after 1 day register
        Mail::to($user->email)->queue( new UserTopRatePsychics($user, $subject, $psychics));
    }
