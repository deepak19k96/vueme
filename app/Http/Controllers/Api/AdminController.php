...
class AdminController extends Controller
{
    ...
    protected function signUp(Request $request)
    {
        ...
        if (!isset($data['month'])) {
            ...
            $psychics = User::select(DB::raw('count(id) as `total`'), DB::raw('MONTH(created_at) as `interval`'))
            ...
            $psychics = User::select(DB::raw('count(id) as `total`'), DB::raw('DAY(created_at) as `interval`'))
