...
class User extends  Authenticatable
{
    ...
    protected $appends = ['userProfile', 'userReferral', 'userMobile', 'userChatRequests', 'modelChatRequests', 'userService', 'categories','userNotifications','buyCredits', 'browserSupported'];
