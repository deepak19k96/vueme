    ...
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
            ...
            <tr>
                <td>
                    <div class="hidden-sm"
                        style="width: 100%; height: 180px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.psychics1on1.com/images/site-images/home-hero-image.png'); text-align: center;">
                    ...
                    <div class="show-sm"
                        style="width: 100%; height: 180px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.psychics1on1.com/images/site-images/home-hero-image-mobile.png'); text-align: center;">
                        <div style="margin-bottom: 40px;padding-top: 40px">
                            <a href="https://www.psychics1on1.com/">
                                <img src="https://www.psychics1on1.com/images/site-images/logo.png" width="159" />
                            </a>
            ...
            <tr>
                ...
                style="line-height: 24px; text-align: center; padding:30px 20px; margin: auto; background: #FFFFFF;">
                    ...
                    <table  class="hidden-sm"  cellspacing="0" cellpadding="0" border="0" style="margin: auto;">        
                      <tr>
                        <td>
                            <a href="https://www.psychics1on1.com/horoscope/{{$signs['url']}}">
                                <img src="https://www.psychics1on1.com/images/horoscopes/{{$signs['url']}}.png" width="118" />
                            </a>
                        </td>
                        <td>
                        <div
                    ...
                    <table  class="show-sm"  cellspacing="0" cellpadding="0" border="0" style="margin: auto;">        
                      <tr>
                        ...
                        <div style=" margin-top: 30px; height: 30px; width: 100%;text-align:center;"><a
                            ...
                            href="https://www.psychics1on1.com/horoscope/{{$signs['url']}}"
                            target="blank">
