...
<meta name="description"
    content="Discover the latest in psychic news via Psychics1on1’s™ blog. Browse by category to learn more about our services. Get advice & guidance exactly when you need it.">
@endsection
@section('title', 'Psychic Blog | Over 2,000 Spiritual Advisors | ')
@section('content')
...
<v-flex class="d-flex d-md-none">
    <v-img src="/images/blog_images/blog_header_mobile.png" aspect-ratio="1"
        ...
        <h1 class="text-center mt-4 white--text" style="font-size: 12px; font-weight: 400">
            Read the Latest Psychic News on Our Radar</h1>
        @endif
        {{--<h2
                    class="subtitle-1 text-center white--text"
                    style="font-size:25px !important"
